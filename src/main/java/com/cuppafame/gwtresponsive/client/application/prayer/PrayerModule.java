 ...
 * @version: 1.0
 *//*
public class PrayerModule extends AbstractPresenterModule {

    @Override
    protected void configure() {
        bindPresenter(PrayerPagePresenter.class, PrayerPagePresenter.MyView.class, PrayerPageView.class,
                PrayerPagePresenter.MyProxy.class);
...
public class PrayerModule implements EntryPoint {
